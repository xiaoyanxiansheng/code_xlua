    ...
    public class LuaEnv : IDisposable
    {
        ...
        public LuaEnv()
        {
            ...
            lock(luaEnvLock)
            {
                ...
                LuaAPI.lua_newtable(rawL); //metatable of indexs and newindexs functions    // stack : newTable1
                LuaAPI.xlua_pushasciistring(rawL, "__index");                               // stack : newTable1 __index
                LuaAPI.lua_pushstdcallcfunction(rawL, StaticLuaCallbacks.MetaFuncIndex);    // stack : newTable1 __index metaFunc
                LuaAPI.lua_rawset(rawL, -3);                                                // stack : newTable1                                : newTable1.__index = metaFunc

            LuaAPI.xlua_pushasciistring(rawL, Utils.LuaIndexsFieldName);                    // stack : newTable1 LuaIndexs
                LuaAPI.lua_newtable(rawL);                                                  // stack : newTable1 LuaIndexs newTable2       
            LuaAPI.lua_pushvalue(rawL, -3);                                                 // stack : newTable1 LuaIndexs newTable2 newTable1         
            LuaAPI.lua_setmetatable(rawL, -2);                                              // stack : newTable1 LuaIndexs newTable2            : newTable2.mt = newTable1
            LuaAPI.lua_rawset(rawL, LuaIndexes.LUA_REGISTRYINDEX);                          // stack : newTable1                                : reg.LuaIndexs = newTable2
                                                                                            
            LuaAPI.xlua_pushasciistring(rawL, Utils.LuaNewIndexsFieldName);                 // 同理                                             : newTable3.mt = newTable1
            LuaAPI.lua_newtable(rawL);                                                      // 同理                                             : reg.LuaNewIndexs = newTable3
            LuaAPI.lua_pushvalue(rawL, -3);
                LuaAPI.lua_setmetatable(rawL, -2);
                LuaAPI.lua_rawset(rawL, LuaIndexes.LUA_REGISTRYINDEX);

                LuaAPI.xlua_pushasciistring(rawL, Utils.LuaClassIndexsFieldName);           // 同理                                             : newTable4.mt = newTable1
            LuaAPI.lua_newtable(rawL);                                                      // 同理                                             : reg.LuaNewIndexs = newTable4
            LuaAPI.lua_pushvalue(rawL, -3);
                LuaAPI.lua_setmetatable(rawL, -2);
                LuaAPI.lua_rawset(rawL, LuaIndexes.LUA_REGISTRYINDEX);

                LuaAPI.xlua_pushasciistring(rawL, Utils.LuaClassNewIndexsFieldName);        // 同理                                             : newTable5.mt = newTable1
            LuaAPI.lua_newtable(rawL);                                                      // 同理                                             : reg.LuaNewIndexs = newTable5
            LuaAPI.lua_pushvalue(rawL, -3);
                LuaAPI.lua_setmetatable(rawL, -2);
                LuaAPI.lua_rawset(rawL, LuaIndexes.LUA_REGISTRYINDEX);
