...
namespace XLua.CSObjectWrap
{
    ...
    public class XLuaTestTestLuaAAAWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(XLuaTest.TestLuaAAA);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					XLuaTest.TestLuaAAA gen_ret = new XLuaTest.TestLuaAAA();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to XLuaTest.TestLuaAAA constructor!");
        ...
        static int _g_get_a(RealStatePtr L)
        {
		    try {
                ...
                XLuaTest.TestLuaAAA gen_to_be_invoked = (XLuaTest.TestLuaAAA)translator.FastGetCSObj(L, 1);
